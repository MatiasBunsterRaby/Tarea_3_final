...
from app.pred_prop import predecir_propina
...
app = modal.App('predecir-propina')
...
def fastapi_app():
    ...
    async def handle_prediction(item: Item, confidence: float = 0.5):
        ...
        pred = predecir_propina(features_trip, '/model/random_forest.joblib', confidence)
        return {'predicted_class': pred}
    
    return web_app

if __name__ == '__main__':
    app.deploy('predecir-propina')
